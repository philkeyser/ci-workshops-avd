...
| ------------------| ----------- | ------------- | ------------- | ------------- | ----------- | -------------------| ------------------|
| s1-brdr1 | 31 | 23 | 6 | 2 | 0 | Hardware, Interfaces | Configuration, System |
...
| s1-spine1 | 25 | 18 | 6 | 1 | 0 | Hardware, Interfaces | System |
| s1-spine2 | 25 | 18 | 6 | 1 | 0 | Hardware, Interfaces | System |
...
| s1-brdr1 | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -76,6 +76,7 @@<br>    ip address 172.16.1.17/31<br> !<br> interface Ethernet3<br>+   shutdown<br> !<br> interface Ethernet4<br>    description P2P_s2-brdr1_Ethernet4<br> |
